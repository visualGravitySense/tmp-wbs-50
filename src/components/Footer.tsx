...
/** Shared social icon for contact-form footer and other chrome. */
export function FooterSocialIcon({ platform }: { platform?: FooterSocialPlatform }) {
  return renderSocialIcon(platform)
}

export function footerSocialAriaLabel(item: FooterSocialItem) {
  return socialAriaLabel(item)
}
