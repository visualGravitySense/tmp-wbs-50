/** Shared by `/testimonials` server page, `/api/reviews`, and scroll client (no GROQ here). */
...
export const ABOUT_PAGE_TESTIMONIALS_PREVIEW = MARKETING_PAGE_TESTIMONIALS_PREVIEW
