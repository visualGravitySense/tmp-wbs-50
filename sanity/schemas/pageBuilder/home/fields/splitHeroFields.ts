...
export const marketingSplitHeroFields = [
  ...
  defineField({
    ...
    options: {
      list: [
        ...
        { title: 'About: Treeneri profiil', value: 'aboutAndres' },
        { title: 'Product diagramm', value: 'opstarDiagram' },
  ...
  defineField({
    ...
    title: 'LinkedIn URL',
    type: 'url',
    description: 'Link treeneri LinkedIn profiilile (ainult treeneri profiili puhul)',
  ...
  defineField({
    ...
    type: 'array',
    description: 'Hõljuvad märgid pildi ümber (ainult treeneri profiili puhul)',
  ...
  defineField({
    ...
    title: 'Product kasumiplokk',
    type: 'reference',
    to: [{ type: 'opstarProfitBlock' }],
    description: 'Viide Product kasumi diagrammile (ainult Product diagrammi puhul)',
